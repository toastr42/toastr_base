...
### An open-source social media manager
This project uses [Material-UI](https://github.com/callemall/material-ui) and was made starting from [this](https://github.com/callemall/material-ui-webpack-example) project.
